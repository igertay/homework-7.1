    ...
    public static void main(String[] args) {
        ...
        for (Map.Entry<Character, Integer> symbol : symbols.entrySet()) {
            if (symbol.getValue() == max) {
                System.out.println("Чаще всего встречается буква: " + symbol.getKey() + ".  Кол-во упоминаний: " + symbol.getValue() + ";");
            }
        }

        for (Map.Entry<Character, Integer> symbol : symbols.entrySet()) {
            if (symbol.getValue() == min) {
                System.out.println("Меньше всего встречается буква: " + symbol.getKey() + ".  Кол-во упоминаний: " + symbol.getValue() + ".");
            }
        }
